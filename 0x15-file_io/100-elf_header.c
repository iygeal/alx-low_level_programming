 ...
 * @elfhdr: Pointer to struct containing header features
 * @fname: File name
 * @fd: file descriptor for `filename'
 */
void get_magic(Elf64_Ehdr *elfhdr, char *fname, int fd)
{
	size_t i = 0;
	unsigned char *mgc = elfhdr->e_ident;
 ...
 * @elfhdr: pointer to struct of header features
 */
void get_class(Elf64_Ehdr *elfhdr)
{
	printf("%-35s", "Class:");
 ...
 * @elfhdr: pointer to struct of ELF header features
 */
void get_data(Elf64_Ehdr *elfhdr)
{
	printf("%-35s", "Data:");
 ...
 * @elfhdr: pointer to struct of ELF header features
 */
void get_velf(Elf64_Ehdr *elfhdr)
{
	printf("%-35s", "Version:");
 ...
 * @elfhdr: pointer to struct of ELF header features
 */
void get_osabi(Elf64_Ehdr *elfhdr)
{
	printf("%-35s", "OS/ABI:");
 ...
 * @elfhdr: pointer to struct of ELF header features
 */
void get_vabi(Elf64_Ehdr *elfhdr)
{
	printf("%-35s%d\n", "ABI Version:", elfhdr->e_ident[EI_ABIVERSION]);
}
 ...
 * @elfhdr: pointer to struct of ELF header features
 */
void get_type(Elf64_Ehdr *elfhdr)
{
	printf("%-35s", "Type:");
 ...
 * @elfhdr: pointer to struct of ELF header features
 */
void get_entry(Elf64_Ehdr *elfhdr)
{
	printf("%-35s0x%lx\n", "Entry point address:",
